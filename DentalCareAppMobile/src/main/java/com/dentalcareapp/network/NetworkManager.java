package com.dentalcareapp.network;
...
public class NetworkManager {
    ...
    private String admin_email = "admin1@dentalcareapp.com";
    ...
    @TargetApi(Build.VERSION_CODES.KITKAT)
    public void updateProfileInfo(JSONObject profile, final NetworkRequest request){
