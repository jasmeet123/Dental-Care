...
import com.dentalcareapp.fragments.userrecord.UserContent.UserItem;

import java.util.List;

/**
 * {@link RecyclerView.Adapter} that can display a {@link UserItem} and makes a call to the
 * specified {@link UserRequestsFragment.OnListFragmentInteractionListener}.
 * TODO: Replace the implementation with code for your data type.
 */
public class MyItemRecyclerViewAdapter extends RecyclerView.Adapter<MyItemRecyclerViewAdapter.ViewHolder> {

    private final List<UserItem> mValues;
    private final UserRequestsFragment.OnListFragmentInteractionListener mListener;

    public MyItemRecyclerViewAdapter(List<UserItem> items, UserRequestsFragment.OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
