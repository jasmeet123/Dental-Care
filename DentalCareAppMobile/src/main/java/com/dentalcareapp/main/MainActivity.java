                ...
                NetworkManager.getInstance().sendProfileInfo(token, new NetworkRequest() {
                    ...
                    public Object success(Object data) {
                        ...
                        if(dataObj != null) {
                            ...
                            UserProfile.getInstance().setServerId(serverId);
                            UserPrefs.getInstance().setServerId(serverId);
                        }
...
// FIXME: 2/20/16
    public void onStart(){
        super.onStart();
        if(UserPrefs.getInstance().isLoggedIn() &&  UserPrefs.getInstance().getLoggedInType().equals(UserProfile.IS_DENTIST)){
